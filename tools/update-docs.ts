...
- [Test source](https://github.com/ota-meshi/eslint-plugin-toml/blob/main/tests/src/rules/${ruleName}.js)
${
    extensionRule
        ? `
...
`
    ...
    public updateFileIntro() {
        ...
        const computed = `---\n${Object.keys(fileIntro)
            .map((key) => `${key}: ${tomlValue((fileIntro as any)[key])}`)
            .join("\n")}\n---\n`
